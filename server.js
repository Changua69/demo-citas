...
app.post('/api/citas', async (req, res) => {
  ...
  try {
    // Ya NO se hace SELECT previo. El constraint UNIQUE en la DB
    // se encarga de rechazar el conflicto de forma atómica.
    ...
    // Código 23505 = violación de UNIQUE constraint en Postgres
    if (error.code === '23505') {
